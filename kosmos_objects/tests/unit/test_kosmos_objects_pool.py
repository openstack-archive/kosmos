...
class TestKosmosObjectsPool(base.TestCase):

    def test_basic(self):
        test_object = kosmos_objects.pool.Pool()
        ...
        test_object.members = [
            kosmos_objects.base.KosmosObject.obj_class_from_name(
                'PoolMember', '1.0')()
        ]
    ...
    def test_from_dict(self):
        ...
        kosmos_objects.base.KosmosObject.obj_from_primitive(test_input)
