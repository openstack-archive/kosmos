...
def upgrade():
    ...
    op.create_table('monitors',
                    ...
                    sa.Column('deleted', sa.CHAR(length=32),
    ...
    op.create_table('loadbalancers',
                    ...
                    sa.Column('zone_name', sa.String(length=255),
                              nullable=True),
                    sa.Column('flavour_id', sa.String(length=36),
                              nullable=True),
                    sa.Column('appliance_id', sa.String(length=36),
                              nullable=True),
    ...
    op.create_table('monitor_parameters',
                    sa.Column('monitor_id', sa.String(length=36),
                              nullable=False),
    ...
    op.create_table('pool_member_parameters',
                    sa.Column('pool_member_id', sa.String(length=36),
                              nullable=False),
                    sa.Column('key', sa.String(length=255), nullable=False),
                    sa.Column('value', sa.String(length=255), nullable=False),
                    sa.ForeignKeyConstraint(
